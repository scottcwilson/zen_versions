...
# $Id: mysql_upgrade_zencart_112_to_114.sql 277 2004-09-10 23:03:52Z wilt $
#

ALTER TABLE `customers_basket_attributes` CHANGE `products_options_sort_order` `products_options_sort_order` TEXT NOT NULL;
