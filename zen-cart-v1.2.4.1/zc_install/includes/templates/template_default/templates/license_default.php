...
// +----------------------------------------------------------------------+
// $Id: license_default.php 290 2004-09-15 19:48:26Z wilt $
//
?>
...
<form method="post" action="index.php?main_page=license<?php if (isset($_GET['language'])) { echo '&language=' . $_GET['language']; } ?>">
  <input type="radio" name="license" id="agree" value="agree" />
  <label for="agree"><?php echo AGREE; ?></label><br />
  <input type="radio" name="license" id="disagree" checked="checked" value="disagree" />
