...
// +----------------------------------------------------------------------+
// $Id: system_setup.php 277 2004-09-10 23:03:52Z wilt $
//
  ...
  define('ENABLE_SSL_INSTRUCTION', 'Would you like to enable Secure Sockets Layer in  Customer area?');
  define('ENABLE_SSL_ADMIN', 'Enable SSL in Admin Area');
  define('ENABLE_SSL_ADMIN_INSTRUCTION', 'Would you like to enable Secure Sockets Layer for Admin areas?');
