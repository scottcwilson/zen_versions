...
// +----------------------------------------------------------------------+
//  $Id: whos_online.php 893 2005-01-06 05:42:47Z ajeh $
//
...
function zen_check_quantity($which) {
  ...
  $who_query = $db->Execute("select session_id, time_entry, time_last_click, host_address
...
<?php
  $whos_online = $db->Execute("select customer_id, full_name, ip_address, time_entry, time_last_click,
                                      last_page_url, session_id, host_address
                               from " . TABLE_WHOS_ONLINE . "
                               order by $order");
...
?>
                <td class="dataTableContentWhois" colspan=4 valign="top">&nbsp;&nbsp;&nbsp;&nbsp;Last Clicked: <?php echo zen_check_minutes($whos_online->fields['time_last_click']); ?> ago</td>
                <td class="dataTableContentWhois" colspan=3 valign="top">Host: <?php echo $whos_online->fields['host_address']; ?></td>
