...
// +----------------------------------------------------------------------+
//  $Id: banner_manager.php 332 2004-09-27 18:58:12Z ajeh $
//
  ...
  if ($action == 'new') {
    ...
    if (isset($_GET['bID'])) {
      ...
      $banner = $db->Execute("select banners_title, banners_url, banners_image, banners_group,
                                     ...
                                     expires_impressions, date_status_change, banners_open_new_windows, banners_on_ssl
                                     from " . TABLE_BANNERS . "
...
<?php
    $banners_query_raw = "select banners_id, banners_title, banners_image, banners_group, status, expires_date, expires_impressions, date_status_change, date_scheduled, date_added, banners_open_new_windows, banners_on_ssl from " . TABLE_BANNERS . " order by banners_title, banners_group";
