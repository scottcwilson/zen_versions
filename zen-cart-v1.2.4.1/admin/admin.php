...
// +----------------------------------------------------------------------+
//$Id: admin.php 949 2005-01-20 15:10:58Z ajeh $
//
...
<a href="' . zen_href_link(FILENAME_ADMIN, 'page=' . $_GET['page'] . '&adminID=' . $adminInfo->admin_id . '&action=resetpassword') . '">' . zen_image_button('button_reset.gif', IMAGE_RESET) . '</a>
