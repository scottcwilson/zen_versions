...
// +----------------------------------------------------------------------+
//  $Id: orders_download.php 277 2004-09-10 23:03:52Z wilt $
      ...
      <tr>
        <td class="main"><table border="1" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <td class="smallText" align="center"><?php echo TEXT_DOWNLOAD_MISSING . '<br />' . zen_image(DIR_WS_IMAGES . 'icon_red_on.gif', IMAGE_ICON_STATUS_OFF); ?></td>
          <tr>
    ...
    while (!$orders_download->EOF) {
      switch (true) {
        case ($orders_download->fields['download_maxdays'] > 0 and $orders_download->fields['download_count'] > 0):
          $zc_file_status = zen_image(DIR_WS_IMAGES . 'icon_green_on.gif', IMAGE_ICON_STATUS_CURRENT);
          break;
        case ($orders_download->fields['download_maxdays'] <= 1 or $orders_download->fields['download_count'] <= 1):
          $zc_file_status = zen_image(DIR_WS_IMAGES . 'icon_yellow_on.gif', IMAGE_ICON_STATUS_EXPIRED);
          break;
        default:
          $zc_file_status = zen_image(DIR_WS_IMAGES . 'icon_yellow_on.gif', IMAGE_ICON_STATUS_EXPIRED);
          break;
