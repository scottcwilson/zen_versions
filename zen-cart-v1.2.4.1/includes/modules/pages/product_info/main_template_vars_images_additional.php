...
// +----------------------------------------------------------------------+
// $Id: main_template_vars_images_additional.php 290 2004-09-15 19:48:26Z wilt $
//
?>
<?php
if ($products_image != '') {
...
//$products_image_large_additional = $products_image_base . IMAGE_SUFFIX_LARGE . $products_image_extention;
  if (file_exists($products_image_large_additional)) {
    echo '<a href="' . zen_href_link($products_image_large_additional) . '" target="_blank">' . zen_image(DIR_WS_IMAGES . $products_image, $products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'hspace="5" vspace="5"') . '<br />' . TEXT_CLICK_TO_ENLARGE . '</a>';
  } else {
