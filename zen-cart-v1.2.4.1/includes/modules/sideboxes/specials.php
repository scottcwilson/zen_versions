...
// test if box should display
  ...
  if ($show_specials == true) {
    $random_product_query = "select p.products_id, pd.products_name, p.products_price,
    ...
    if ($random_product->RecordCount() > 0)  {
      $specials_box_price = zen_get_products_display_price($random_product->fields['products_id']);
