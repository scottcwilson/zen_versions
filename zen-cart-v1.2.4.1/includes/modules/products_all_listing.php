...
// +----------------------------------------------------------------------+
// $Id: products_all_listing.php 290 2004-09-15 19:48:26Z wilt $
//
?>
...
<?php
  ...
  if ($products_all_split->number_of_rows > 0) {
    ...
    while (!$products_all->EOF) {
      ...
      if (PRODUCT_ALL_LIST_PRICE != '0' and zen_get_products_allow_add_to_cart($products_all->fields['products_id']) == 'Y') {
