...
// +----------------------------------------------------------------------+
// $Id: downloads.php 750 2004-12-09 07:25:42Z ajeh $
//
...
// - The expiry date is not reached
      if ( ($downloads->fields['download_count'] > 0) && (file_exists(DIR_FS_DOWNLOAD . $downloads->fields['orders_products_filename'])) && ( ($downloads->fields['download_maxdays'] == 0) || ($download_timestamp > time())) ) {
        ...
        echo '            <td align="center"><a href="' . zen_href_link(FILENAME_DOWNLOAD, 'order=' . $last_order . '&id=' . $downloads->fields['orders_products_download_id']) . '">' . zen_image_button(BUTTON_IMAGE_DOWNLOAD, BUTTON_DOWNLOAD_ALT) . '<br />' . $downloads->fields['products_name'] . '<br />' . number_format($zv_filesize) . TEXT_FILESIZE_BYTES . '</a></td>' . "\n";
      } else {
