...
// +----------------------------------------------------------------------+
// $Id: upload.php 290 2004-09-15 19:48:26Z wilt $
//
// iii changed:  all references to $message_stack were commented out, since it is not defined here
  ...
  class upload {
    ...
    function upload($file = '', $destination = '', $permissions = '666', $extensions = array('jpg', 'jpeg', 'gif', 'png', 'eps', 'cdr', 'ai', 'pdf', 'tif', 'tiff', 'bmp', 'zip')) {
      $this->set_file($file);
