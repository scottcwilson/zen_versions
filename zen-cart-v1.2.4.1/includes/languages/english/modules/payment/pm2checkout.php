...
// +----------------------------------------------------------------------+
// $Id: pm2checkout.php 277 2004-09-10 23:03:52Z wilt $
//

  define('MODULE_PAYMENT_2CHECKOUT_TEXT_ADMIN_TITLE', '2CheckOut');
  define('MODULE_PAYMENT_2CHECKOUT_TEXT_CATALOG_TITLE', 'Credit Card');  // Payment option title as displayed to the customer
